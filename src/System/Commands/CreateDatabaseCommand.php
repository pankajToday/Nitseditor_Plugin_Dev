...
class CreateDatabaseCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if(count($plugins) > 1)
        {
            ...
            {
                $dbPath = $this->directoryPath .'\\'. $pluginName . '\Databases\\' . $dbName . '.php';
        ...
        else
        {
            ...
            {
                $dbPath = $plugin . '\Databases\\' . $dbName . '.php';
...
namespace Nitseditor\Plugins\\'. $pluginName .'\Database;        

use Illuminate\Support\Facades\Schema;
use Illuminate\Database\Schema\Blueprint;
use Nitseditor\System\Database\Migration;

class '. $dbName .'Table extends Migration
{
    /**
     * Run the migrations.
     *
